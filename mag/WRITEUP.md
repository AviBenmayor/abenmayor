...
pre-fee/post-fee mismatch between the two holds is called out above rather than
silently corrected, because the data doesn't settle which one the model meant.
